...
import styles from './desktop-contact-us.module.scss';
...
type DesktopContactUsProps = {
    language: string;
};

function DesktopContactUs(props: DesktopContactUsProps) {
    ...
    async function handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            formData.append('email', isLoggedIn ? info.username! : email);
        ...
        <div className={styles.container}>
            ...
            >
                ...
                <div className={styles['container__form__issue']}>
                    ...
                    {isIssueSelectOpen && (
                        <DesktopModal
                            title={t('contactUs.issue')}
                            handleClose={() => setIssueSelectOpen(false)}
                        >
                            <div className={styles['container__modal__issue']}>
                                <div
                                    className={
                                        styles['container__modal__issue__list']
                                    }
                                >
                                    {helpText?.help_title.map((issue) => (
                                        <p
                                            ...
                                            className={classNames(
                                                styles[
                                                    'container__modal__issue__list__item'
                                                ],
                                                {
                                                    [styles[
                                                        'container__modal__issue__list__item--selected'
                                                    ]]:
                                                        issueTitleId ===
                                                        issue.id,
                                                },
                ...
                {issueTitleId > 0 && (
                    <div className={styles['container__form__problem']}>
                        ...
                        {isProblemSelectOpen && (
                            <DesktopModal
                                title={t('contactUs.problem')}
                                handleClose={() => setProblemSelectOpen(false)}
                            >
                                <div
                                    className={
                                        styles['container__modal__problem']
                                    }
                                >
                                    <div
                                        className={
                                            styles[
                                                'container__modal__problem__list'
                                            ]
                                        }
                                    >
                                        {helpText?.help_title
                                            ...
                                            ?.subject.map((subject) => (
                                                <p
                                                    ...
                                                    className={classNames(
                                                        styles[
                                                            'container__modal__problem__list__item'
                                                        ],
                                                        {
                                                            [styles[
                                                                'container__modal__problem__list__item--selected'
                                                            ]]:
                                                                problemId ===
                                                                subject.id,
                                                        },
